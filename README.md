...
- **deadlight-proxy** (C, ★ 9): HTTP/HTTPS/SMTP/IMAP/FTP/SOCKS bridge + VPN. [Android App Now Available](#deadlight-proxy-android-app)
- **deadmesh** (C, ★ 76): LoRa-to-internet gateway. [Project site](https://deadmesh.boo)
